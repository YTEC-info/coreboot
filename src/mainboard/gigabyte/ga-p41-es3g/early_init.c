...
void bootblock_mainboard_early_init(void)
{
	...
	ite_reg_write(GPIO_DEV, 0x26, 0xff);
	...
	ite_reg_write(GPIO_DEV, 0xb9, 0xc0);
	ite_reg_write(GPIO_DEV, 0xbb, 0x40);
	ite_reg_write(GPIO_DEV, 0xc0, 0x00);
	ite_reg_write(GPIO_DEV, 0xc1, 0xdf);
	ite_reg_write(GPIO_DEV, 0xc3, 0x01);
	ite_reg_write(GPIO_DEV, 0xc4, 0x08);
	ite_reg_write(GPIO_DEV, 0xc8, 0x01);
	...
	ite_reg_write(GPIO_DEV, 0xfc, 0x48);
